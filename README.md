...
Có hai cách để thay đổi ngôn ngữ:

1. Khi app thay đổi ngôn ngữ, hãy dùng hàm **setLocalizationStrings(strings)** để thay đổi ngôn ngữ cho VBot SDK
...
2. Truyền dữ liệu qua metadata khi gọi hàm **startIncomingCall**
