...
- (nonnull instancetype)initWithUuid:(NSUUID * _Nonnull)uuid callId:(NSString * _Nonnull)callId name:(NSString * _Nonnull)name avatar:(NSString * _Nonnull)avatar OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12VBotPhoneSDK26ReturnToCallViewController")
@interface ReturnToCallViewController : UIViewController
- (void)loadView;
